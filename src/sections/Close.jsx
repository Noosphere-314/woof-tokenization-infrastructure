...
const FAQS = [
  ...
  ['Do you handle the legal and regulatory side?',
   'We build the software and encode your compliance rules on-chain (eligibility, lockups, jurisdictions). The legal structure itself — offering documents, licensing, transfer agent — stays with your counsel and licensed partners; we integrate with them and have done Reg D / Reg S and MiFID II-aligned setups. We build to the structures tokenized funds actually use today: BVI and Cayman feeders and segregated portfolios, Hong Kong and Singapore vehicles, and US 506(c) private placements.'],
  ['What does it cost?',
  ...
  ['We already run a permissionless vault. How do we take institutional money into it?',
   'You do not retrofit it — the eligibility rules have to live in the token, and a deployed ERC-20 cannot grow them later. The usual path is a second, permissioned share class alongside the open one: same strategy, same accounting, but transfers checked against an identity registry so a compliance officer can sign off. Existing holders are untouched. If your vault is already ERC-4626, the accounting carries over and the work is the compliance layer and the subscription queue, not a rebuild.'],
